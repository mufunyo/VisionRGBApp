ToolBarDemo Example
===================
This project demonstrates the how to customize a ToolBar. A ToolBar is
a window control which has one or more buttons. Clicking these sends
a command message to the parent window, much like selecting a menu
item.

In this program we can use window's ToolBar customize feature to
...
=====================================
* Adding a ToolBar to a Frame window
