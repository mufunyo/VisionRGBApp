...
Some compilers (Borland version 5.5) may not support GDI+.
Some older Microsoft compilers (VS6) will require the Platform SDK integrated 
with it to compile this code.
